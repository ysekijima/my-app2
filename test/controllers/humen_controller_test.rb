...
class HumenControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create human" do
    assert_difference("Human.count") do
      post humen_url, params: { human: { memo: @human.memo, name: @human.name, number: @human.number, size: @human.size } }
    end
  ...
  test "should update human" do
    patch human_url(@human), params: { human: { memo: @human.memo, name: @human.name, number: @human.number, size: @human.size } }
